...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    virtual void seek(audio::Uint64 sampleOffset);
    ...
    ///
    ////////////////////////////////////////////////////////////
    virtual audio::Uint64 read(audio::Int16* samples, audio::Uint64 maxCount);
...
private:
    ...
    audio::Uint64 m_dataStart;      ///< Starting position of the audio data in the open file
    audio::Uint64 m_dataEnd;        ///< Position one byte past the end of the audio data in the open file
};
