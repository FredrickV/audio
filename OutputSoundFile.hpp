...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB bool openFromFile(const std::string& filename, unsigned int sampleRate, unsigned int channelCount);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB void write(const audio::Int16* samples, audio::Uint64 count);
