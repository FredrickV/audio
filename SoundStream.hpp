...
public:
    ...
    struct Chunk
    {
        const audio::Int16* samples;     ///< Pointer to the audio samples
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB unsigned int getChannelCount() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB unsigned int getSampleRate() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB void setPlayingOffset(Time timeOffset);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB Time getPlayingOffset() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB void setLoop(bool loop);
...
protected:
    ...
    ///
    ////////////////////////////////////////////////////////////
    virtual void initialize(unsigned int channelCount, unsigned int sampleRate);
...
private:
    ...
    std::mutex     m_threadMutex;              ///< Thread mutex
    Status         m_threadStartState;         ///< State the thread starts in (Playing, Paused, Stopped)
    bool           m_isStreaming;              ///< Streaming state (true = playing, false = stopped)
    unsigned int   m_buffers[BufferCount];     ///< Sound buffers used to store temporary audio data
    unsigned int   m_channelCount;             ///< Number of channels (1 = mono, 2 = stereo, ...)
    unsigned int   m_sampleRate;               ///< Frequency (samples / second)
    audio::Uint32  m_format;                   ///< Format of the internal sound buffers
    bool           m_loop;                     ///< Loop flag (true to loop, false to play once)
    audio::Uint64  m_samplesProcessed;         ///< Number of buffers processed since beginning of the stream
    audio::Int64   m_bufferSeeks[BufferCount]; ///< If buffer is an "end buffer", holds next seek position, else NoLoop. For play offset calculation.
};
