...
public:
    ...
    struct Info
    {
        audio::Uint64       sampleCount;  ///< Total number of samples in the file
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual ~SoundFileReader() {}
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual bool open(InputStream& stream, Info& info) = 0;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual void seek(audio::Uint64 sampleOffset) = 0;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual audio::Uint64 read(audio::Int16* samples, audio::Uint64 maxCount) = 0;
};
