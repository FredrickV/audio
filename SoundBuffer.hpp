...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB SoundBuffer(const SoundBuffer& copy);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB bool loadFromFile(const std::string& filename);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB bool loadFromMemory(const void* data, std::size_t sizeInBytes);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB bool loadFromStream(InputStream& stream);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB bool loadFromSamples(const audio::Int16* samples, audio::Uint64 sampleCount, unsigned int channelCount, unsigned int sampleRate);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB bool saveToFile(const std::string& filename) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB const audio::Int16* getSamples() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB audio::Uint64 getSampleCount() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB Time getDuration() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB SoundBuffer& operator =(const SoundBuffer& right);
...
private:
    ...
    std::vector<audio::Int16> m_samples;  ///< Samples buffer
