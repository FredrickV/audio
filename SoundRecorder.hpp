...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual ~SoundRecorder();
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB bool start(unsigned int sampleRate = 44100);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB static std::vector<std::string> getAvailableDevices();
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB static std::string getDefaultDevice();
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB bool setDevice(const std::string& name);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB const std::string& getDevice() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB void setChannelCount(unsigned int channelCount);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB static bool isAvailable();
...
protected:
    ...
    ///
    ////////////////////////////////////////////////////////////
    virtual bool onProcessSamples(const audio::Int16* samples, std::size_t sampleCount) = 0;
...
private:
    ...
    std::vector<audio::Int16> m_samples;            ///< Buffer to store captured samples
