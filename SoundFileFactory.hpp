...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB static SoundFileReader* createReaderFromFilename(const std::string& filename);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB static SoundFileReader* createReaderFromMemory(const void* data, std::size_t sizeInBytes);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB static SoundFileReader* createReaderFromStream(InputStream& stream);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB static SoundFileWriter* createWriterFromFilename(const std::string& filename);
