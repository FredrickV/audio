...
////////////////////////////////////////////////////////////
void SoundFileReaderOgg::seek(audio::Uint64 sampleOffset)
{
...
////////////////////////////////////////////////////////////
audio::Uint64 SoundFileReaderOgg::read(audio::Int16* samples, audio::Uint64 maxCount)
{
    assert(m_vorbis.datasource);
    ...
    {
        int bytesToRead = static_cast<int>(maxCount - count) * sizeof(audio::Int16);
        long bytesRead = ov_read(&m_vorbis, reinterpret_cast<char*>(samples), bytesToRead, 0, 2, 1, NULL);
        if (bytesRead > 0)
        {
            long samplesRead = bytesRead / sizeof(audio::Int16);
            count += samplesRead;
            samples += samplesRead;
        }
        else
