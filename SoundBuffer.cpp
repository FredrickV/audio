...
////////////////////////////////////////////////////////////
bool SoundBuffer::loadFromSamples(const audio::Int16* samples, audio::Uint64 sampleCount, unsigned int channelCount, unsigned int sampleRate)
{
...
////////////////////////////////////////////////////////////
const audio::Int16* SoundBuffer::getSamples() const
{
...
////////////////////////////////////////////////////////////
audio::Uint64 SoundBuffer::getSampleCount() const
{
...
bool SoundBuffer::initialize(InputSoundFile& file)
{
    ...
    audio::Uint64 sampleCount  = file.getSampleCount();
...
bool SoundBuffer::update(unsigned int channelCount, unsigned int sampleRate)
{
    ...
    // Fill the buffer
    ALsizei size = static_cast<ALsizei>(m_samples.size()) * sizeof(audio::Int16);
