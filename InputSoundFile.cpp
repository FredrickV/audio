...
////////////////////////////////////////////////////////////
audio::Uint64 InputSoundFile::getSampleCount() const
{
...
////////////////////////////////////////////////////////////
audio::Uint64 InputSoundFile::getSampleOffset() const
{
...
////////////////////////////////////////////////////////////
void InputSoundFile::seek(audio::Uint64 sampleOffset)
{
    if (m_reader)
    {
...
{
    seek(static_cast<audio::Uint64>(timeOffset.asSeconds() * m_sampleRate * m_channelCount));
}


////////////////////////////////////////////////////////////
audio::Uint64 InputSoundFile::read(audio::Int16* samples, audio::Uint64 maxCount)
{
    audio::Uint64 readSamples = 0;
