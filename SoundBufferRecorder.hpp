...
protected:
    ...
    ///
    ////////////////////////////////////////////////////////////
    virtual bool onProcessSamples(const audio::Int16* samples, std::size_t sampleCount);
...
private:
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    std::vector<audio::Int16> m_samples; ///< Temporary sample buffer to hold the recorded data
