...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB TimeSpan getLoopPoints() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB void setLoopPoints(TimeSpan timePoints);
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    audio::Uint64 timeToSamples(Time position) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    Time samplesToTime(audio::Uint64 samples) const;

    ////////////////////////////////////////////////////////////
    // Member data
    ////////////////////////////////////////////////////////////
    InputSoundFile            m_file;     ///< The streamed music file
    std::vector<audio::Int16> m_samples;  ///< Temporary buffer of samples
    std::mutex                m_mutex;    ///< Mutex protecting the data
    Span<audio::Uint64>       m_loopSpan; ///< Loop Range Specifier
};
