...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB bool openFromFile(const std::string& filename);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB bool openFromMemory(const void* data, std::size_t sizeInBytes);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB bool openFromStream(InputStream& stream);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB Time getTimeOffset() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB audio::Uint64 getSampleOffset() const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB void seek(audio::Uint64 sampleOffset);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB void seek(Time timeOffset);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB audio::Uint64 read(audio::Int16* samples, audio::Uint64 maxCount);
...
private:
    ...
    audio::Uint64    m_sampleOffset; ///< Sample Read Position
    audio::Uint64    m_sampleCount;  ///< Total number of samples in the file
