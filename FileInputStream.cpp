...
////////////////////////////////////////////////////////////
audio::Int64 FileInputStream::read(void* data, audio::Int64 size)
{
#ifdef ANDROID
...
////////////////////////////////////////////////////////////
audio::Int64 FileInputStream::seek(audio::Int64 position)
{
#ifdef ANDROID
...
////////////////////////////////////////////////////////////
audio::Int64 FileInputStream::tell()
{
#ifdef ANDROID
    return m_file->tell();
#else
...
////////////////////////////////////////////////////////////
audio::Int64 FileInputStream::getSize()
{
#ifdef ANDROID
    ...
    if (m_file)
    {
        audio::Int64 position = tell();
        std::fseek(m_file, 0, SEEK_END);
        audio::Int64 size = tell();
        seek(position);
        return size;
    }
    else
