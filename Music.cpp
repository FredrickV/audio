...
{
    Span<audio::Uint64> samplePoints(timeToSamples(timePoints.offset), timeToSamples(timePoints.length));
...
bool Music::onGetData(SoundStream::Chunk& data)
{
    ...
    audio::Uint64 currentOffset = m_file.getSampleOffset();
    audio::Uint64 loopEnd = m_loopSpan.offset + m_loopSpan.length;
...
////////////////////////////////////////////////////////////
audio::Uint64 Music::timeToSamples(Time position) const
{
...
////////////////////////////////////////////////////////////
Time Music::samplesToTime(audio::Uint64 samples) const
{
