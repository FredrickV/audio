...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB void open(const void* data, std::size_t sizeInBytes);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual audio::Int64 read(void* data, audio::Int64 size);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual audio::Int64 seek(audio::Int64 position);
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual audio::Int64 tell();
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual audio::Int64 getSize();
...
private:
    ...
    audio::Int64       m_size;   ///< Total size of the data
    audio::Int64       m_offset; ///< Current reading position
};
