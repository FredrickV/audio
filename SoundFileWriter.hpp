...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual ~SoundFileWriter() {}
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual bool open(const std::string& filename, unsigned int sampleRate, unsigned int channelCount) = 0;
    ...
    ///
    ////////////////////////////////////////////////////////////
    AUDIO_LIB virtual void write(const audio::Int16* samples, audio::Uint64 count) = 0;
};
